/*Q4.Create a PROJECT table with fields project_id, Project_name, Project_description, Project_Status. etc. 
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == Display) {
            ...
            try {
                ...
                con = DriverManager.getConnection("jdbc:postgresql://localhost:5432/tybcs", "postgres", "postgres");
...
class Insert extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/tybcs", "postgres", "postgres");

            if (ae.getSource() == btnadd) {
                pstmt = conn.prepareStatement("insert into fields values(?,?,?,?)");
